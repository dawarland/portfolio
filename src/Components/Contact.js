                    ...
                    <form className="row" action="https://webto.salesforce.com/servlet/servlet.WebToCase?encoding=UTF-8" method="POST">
                        <div className="col-12 col-xs-10 col-xs-offset-1 col-md-offset-0">
                            ...
                            <div className="form-group">
                                <input id="name" placeholder="Nom & Prénom" className="form-control" maxLength="80" name="name" size="20" type="text" required/>
                            </div>
                            <div className="form-group">
                                <input id="email" placeholder="E-mail" className="form-control" maxLength="80" name="email" size="20" type="text" required/>
                            </div>
                            <div className="form-group">
                                <input id="subject" placeholder="Objet" className="form-control" maxLength="80" name="subject" size="20" type="text" required/>
                            </div>
                            <div className="form-group">
